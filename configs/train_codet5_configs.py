...
# Logging
parser.add_argument('--log_freq', default=10, type=int, help='save training log after this number of training steps')
parser.add_argument('--save_freq', default=3580, type=int, help='save model checkpoints after this number of training steps')
