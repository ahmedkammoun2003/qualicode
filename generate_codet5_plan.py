...
def main(args):
    ...
    for index, problem in tqdm(enumerate(problems), ncols=0, total=len(problems)):
        ...
        # Check if the last part of the path can be converted to an integer
        problem_id_str = problem.split('/')[-1]
        if not problem_id_str.isdigit():
            print(f"Skipping invalid problem id: {problem_id_str}")
            continue
...
if __name__ == "__main__":
    ...
    from configs.generate_codet5_plan_configs import * 
