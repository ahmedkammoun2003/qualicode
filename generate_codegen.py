...
def main(args):
    ...
    # Add Hugging Face login with token
    login(token='')

    # Set up model
    tokenizer = AutoTokenizer.from_pretrained('Salesforce/codegen-350M-mono', use_auth_token='')
    print("Loading model from {}...".format(args.model_path))
    model = AutoModelForCausalLM.from_pretrained(args.model_path, pad_token_id=tokenizer.eos_token_id, clone_pl_head=args.plan_head, use_auth_token='YOUR_HUGGINGFACE_TOKEN')
